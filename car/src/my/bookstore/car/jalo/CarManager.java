...
/**
 * This is the extension manager of the Car extension.
 */
public class CarManager extends GeneratedCarManager
{
	...
	{
		return (CarManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				CarConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CarManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CarManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CarManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CarManager called, current tenant: " + getTenant().getTenantID());
		}
	}
